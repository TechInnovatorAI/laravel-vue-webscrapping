"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Screens_Scraper_AthleteRankings_vue"],{
...
/* harmony export */ });
/* harmony import */ var _initFirebase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../initFirebase */ "./resources/js/initFirebase.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    var user = _initFirebase__WEBPACK_IMPORTED_MODULE_0__.auth.currentUser;
    if (!user) {
      window.location.href = "/";
    } else {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var AthleteRankings = {
  ...
  computed: {
    alternatingRows: function alternatingRows(currentIndex) {
      var rows = [];
      for (var i = 0; i < currentIndex; i++) {
        // Add a data row
        rows.push({
          type: "data",
          data: this.tournaments[i]
        });
      ...
      for (var _i = currentIndex + 1; _i < this.tournaments.length; _i++) {
        // Add a data row
        rows.push({
          type: "data",
          data: this.tournaments[_i]
        });
      }
      return rows;
    }
  ...
  data: function data() {
    return {
      ...
      //{ name: "Default Inputs", code: "all", value: 7 }

      sortingOptions: [{
        name: "Official Ranking Ascending",
        code: "ra"
      }, {
        name: "Official Ranking Descending",
        code: "rd"
      }, {
        name: "Wins Ascending",
        code: "wa"
        ...
        name: "Loses Ascending",
        code: "la"
      }, {
        name: "Loses Descending",
        code: "ld"
      }, {
        name: "Points Scored Ascending",
        code: "pa"
      }, {
        name: "Points Scored Descending",
        code: "pd"
      }, {
        name: "Points Suffered Ascending",
        code: "sa"
      }, {
        name: "Points Suffered Descending",
        code: "sd"
      }, {
        name: "Points Diff Ascending",
        code: "pda"
      }, {
        name: "Points Diff Descending",
        code: "pdd"
      }, {
        name: "Total Matches Ascending",
        code: "tma"
      }, {
        name: "Total Matches Descending",
        code: "tmd"
      }],
      maxOptions: [{
        name: "Three",
      ...
      actionIndex: (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)(-1)
    };
  },
  created: function created() {
  ...
  methods: {
    requestPay: function requestPay(id, amount, e) {
      var _this = this;
      ...
      (0,_paypal_paypal_js__WEBPACK_IMPORTED_MODULE_3__.loadScript)({
        ...
        paypal.Buttons({
          ...
          onApprove: function onApprove(data, actions) {
            self.axios.post("".concat(self.$apiUrl, "auth/updateEnddate"), {
    ...
    openModal: function openModal(index, event) {
      var _this2 = this;
      ...
      if (this.actionIndex === index) {
        ...
        this.actionIndex = index;
        var playerName = this.tournaments[this.actionIndex].name;
        var playerId = this.tournaments[this.actionIndex].id;
        this.playerName = playerName;
        var data = {
          name: playerName,
          filters: this.filters
        };
        this.axios.post("".concat(this.$apiUrl, "fetch-tournament-details"), data).then(function (response) {
          // Assuming the response data structure matches what the Laravel method returns
          _this2.tournamentData = {
    ...
    getFilters: function getFilters() {
      ...
      this.axios.get("".concat(this.$apiUrl, "tournaments/updateFilter")).then(function (response) {
        ...
        _this3.weights = response.data.weights;
        _this3.weightGroups = response.data.weightGroups;
        _this3.tournamentTypes = response.data.tournamentTypes;
    ...
    applyFilters: function applyFilters() {
      ...
      this.axios.get("".concat(this.$apiUrl, "tournaments/athlete-filter"), {
        params: _objectSpread(_objectSpread({}, filtersCopy), {}, {
          topOpentounaments: this.topOpentounaments.value
        })
      }).then(function (response) {
        _this4.tournaments = response.data;
        _this4.noti("success", "Data fetched successfully"); // Show notification on success
        _this4.$nextTick(function () {
          // Ensure DOM is updated
          _this4.$refs.resultsSection.scrollIntoView({
            behavior: "smooth"
          }); // Scroll to table
        });
        ...
        _this4.noti("error", "Failed to fetch data"); // Show notification on error
        _this4.isLoading = false;
      });
    },
    ...
    addWeightGroups: function addWeightGroups() {
      if (this.selectedWeightGroups && !this.filters.weightGroups.includes(this.selectedWeightGroups)) {
        this.filters.weightGroups.push(this.selectedWeightGroups);
      }
      this.selectedWeightGroups = null;
    },
    removeWeightGroup: function removeWeightGroup(index) {
    ...
    getWeightGroupByCategory: function getWeightGroupByCategory(category) {
      var _this5 = this;
      var url = "".concat(this.$apiUrl, "getWeightGroupByCategory/").concat(category);
      this.axios.get(url).then(function (response) {
        // Merge new weights with existing ones
        var newWeightGroups = new Set([].concat(_toConsumableArray(_this5.weightGroups), _toConsumableArray(response.data.weightGroups)));
        _this5.weightGroups = Array.from(newWeightGroups);
        // console.log('weight group',this.weightGroups);
      })["catch"](function (error) {
        console.error("Error fetching weightGroups:", error);
      });
    },
    getWeightByCategory: function getWeightByCategory(category) {
      var _this6 = this;
      var url = "".concat(this.$apiUrl, "getWeightByCategory/").concat(category);
      this.axios.get(url).then(function (response) {
        // Merge new weights with existing ones
        var newWeights = new Set([].concat(_toConsumableArray(_this6.weights), _toConsumableArray(response.data.weights)));
        _this6.weights = Array.from(newWeights);
    ...
    updateWeightsAndGroups: function updateWeightsAndGroups() {
      var _this7 = this;
      this.weights = [];
      this.weightGroups = [];
      this.filters.category.forEach(function (category) {
        _this7.getWeightByCategory(category);
        _this7.getWeightGroupByCategory(category);
      });
    },
    ...
    removeCountry: function removeCountry(index) {
      this.filters.country.splice(index, 1);
    },
    sortByOfficialRankingAscending: function sortByOfficialRankingAscending() {
      this.tournaments.sort(function (a, b) {
        return a.official_ranking - b.official_ranking;
      });
    },
    sortByOfficialRankingDescending: function sortByOfficialRankingDescending() {
      this.tournaments.sort(function (a, b) {
        return b.official_ranking - a.official_ranking;
      });
    },
    sortByWinsAscending: function sortByWinsAscending() {
      this.tournaments.sort(function (a, b) {
        return a.win - b.win;
      });
    },
    sortByWinsDescending: function sortByWinsDescending() {
      this.tournaments.sort(function (a, b) {
        return b.win - a.win;
      });
    },
    sortByLosesAscending: function sortByLosesAscending() {
      // console.log('lose asc');
      this.tournaments.sort(function (a, b) {
        return a.lose - b.lose;
      });
    },
    sortByTotalMatchesDes: function sortByTotalMatchesDes() {
      this.tournaments.sort(function (a, b) {
        return b.matches.length - a.matches.length;
      });
    },
    sortByTotalMatchesAsc: function sortByTotalMatchesAsc() {
      this.tournaments.sort(function (a, b) {
        return a.matches.length - b.matches.length;
      });
    },
    sortByLosesDescending: function sortByLosesDescending() {
      this.tournaments.sort(function (a, b) {
        return b.lose - a.lose;
      });
    },
    sortByDiffAscending: function sortByDiffAscending() {
      this.tournaments.sort(function (a, b) {
        return a.difference - b.difference;
      });
    },
    sortByDiffDescending: function sortByDiffDescending() {
      this.tournaments.sort(function (a, b) {
        return b.difference - a.difference;
      });
    },
    sortByPointsAscending: function sortByPointsAscending() {
      this.tournaments.sort(function (a, b) {
        return a.point_scored - b.point_scored;
      });
    },
    sortByPointsDescending: function sortByPointsDescending() {
      this.tournaments.sort(function (a, b) {
        return b.point_scored - a.point_scored;
      });
    },
    sortBySufferedAscending: function sortBySufferedAscending() {
      this.tournaments.sort(function (a, b) {
        return a.point_suffered - b.point_suffered;
      });
    },
    sortBySufferedDescending: function sortBySufferedDescending() {
      this.tournaments.sort(function (a, b) {
        return b.point_suffered - a.point_suffered;
      });
    },
    sortByPointsDiffAscending: function sortByPointsDiffAscending() {
      this.tournaments.sort(function (a, b) {
        return a.point_diff - b.point_diff;
      });
    },
    sortByPointsDiffDescending: function sortByPointsDiffDescending() {
      this.tournaments.sort(function (a, b) {
    ...
    sorted: function sorted() {
      ...
      this.selectedSortings.forEach(function (sorting) {
        // console.log('start sorting of',sorting);
        _this8.applySorting(sorting);
      });
    },
    applySorting: function applySorting(sortingOption) {
    ...
    resetTournaments: function resetTournaments() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AthleteRankings);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sidebar scroll"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
  ...
  }, _hoisted_6)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sidebar navigation"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("nav", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ============================= "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Home "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ============================= "), _hoisted_9, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" =================== "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Dashboard "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" =================== "), $data.isVisible ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    "class": "sidebar-link",
    to: "/dashboard",
    "aria-expanded": "false",
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    "class": "sidebar-link",
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_17, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    "class": "sidebar-link",
    to: "/tournament-type",
    "aria-expanded": "false",
    onClick: _ctx.onClose
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      }, null, 8 /* PROPS */, _hoisted_18)]), _hoisted_19];
    }),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_20, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    "class": "sidebar-link",
    to: "/athlete-rankings",
    "aria-expanded": "false",
    onClick: _ctx.onClose
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <li class=\"sidebar-item\">\n                            <router-link class=\"sidebar-link\" to=\"/tournament-filter\" aria-expanded=\"false\" @click=\"onClose\">\n                                <span>\n                                    <img :src=\"`${$appDir}menu/ranking.png`\" style=\"height:20px\" />\n                                </span>\n                                <span class=\"hide-menu\">Ranking</span>\n                            </router-link>\n                            </li> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    "class": "sidebar-link",
    to: "/settings",
    "aria-expanded": "false",
    onClick: _ctx.onClose
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])])])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_26, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_27, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    "class": "sidebar-link",
    to: "/athlete-rankings",
    "aria-expanded": "false",
    onClick: _ctx.onClose
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      }, null, 8 /* PROPS */, _hoisted_28)]), _hoisted_29];
    }),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onClick"])])])), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_30, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    "class": "sidebar-link",
  ...
  }, null, 8 /* PROPS */, _hoisted_31)]), _hoisted_32])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" End Sidebar navigation ")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" End Sidebar scroll")])]);
}

/***/ }),

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _withScopeId = function _withScopeId(n) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.pushScopeId)("data-v-999730d6"), n = n(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.popScopeId)(), n;
};
...
var _hoisted_16 = /*#__PURE__*/_withScopeId(function () {
  ...
  }, "Athlete Ranking Results", -1 /* HOISTED */);
});
var _hoisted_17 = {
  "class": "row"
};
...
var _hoisted_40 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Weight Group", -1 /* HOISTED */);
});
...
var _hoisted_65 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Input Selection", -1 /* HOISTED */);
});
var _hoisted_66 = {
  "class": "col-md-3"
};
var _hoisted_67 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Sorting:", -1 /* HOISTED */);
});
var _hoisted_68 = {
...
var _hoisted_70 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    ...
    scope: "col"
  }, "Official R"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <th scope=\"col\">R1</th>\n                                                <th scope=\"col\">R2</th> "), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
  }, "Wins"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
  }, "Loses"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
  }, "Wins-Loses Diff"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
  }, "Points Scored"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
  }, "Points Suffered"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
  }, "Points Diff"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
  }, "Matches"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    scope: "col"
...
var _hoisted_80 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Tournament Name"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Official Ranking"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <th>\n                                                                        Ranking\n                                                                        1\n                                                                    </th>\n                                                                    <th>\n                                                                        Ranking\n                                                                        2\n                                                                    </th> "), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Win"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Lose"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Win Lose Diff"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Point Scored"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Point Suffered"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Point Diff"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", null, "Matches")])], -1 /* HOISTED */);
});
var _hoisted_81 = {
  key: 0
};
...
var _hoisted_84 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "class": "fas fa-search"
  })]), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h5", null, "free for a week"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Explore this site for free.")], -1 /* HOISTED */);
});
var _hoisted_85 = {
  "class": "form-input",
...
var _hoisted_88 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "class": "fas fa-search"
  })]), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h5", null, "Avalible for a month"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Explore this site for free.")], -1 /* HOISTED */);
});
var _hoisted_89 = {
  "class": "form-input"
};
...
var _hoisted_93 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "class": "fas fa-search"
  })]), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h5", null, "Avalible for six months"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Explore this site.")], -1 /* HOISTED */);
});
var _hoisted_94 = {
  "class": "form-input"
};
...
var _hoisted_98 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "class": "fas fa-search"
  })]), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h5", null, "Avalible for a year"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Explore this site.")], -1 /* HOISTED */);
});
var _hoisted_99 = {
  "class": "form-input"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    src: "".concat(_ctx.$images, "logo.png"),
    "class": "dark-logo",
    style: {
      "height": "40px"
    }
    ...
    "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
      return _ctx.selectedYear = $event;
    }),
    "class": "form-control rounded-0",
    onChange: _cache[2] || (_cache[2] = function () {
      return _ctx.addYear && _ctx.addYear.apply(_ctx, arguments);
    })
  }, [_hoisted_20, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.years, function (year) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: year
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(year), 1 /* TEXT */);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.selectedYear]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_21, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.filters.year, function (year, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      "class": "badge bg-warning m-1 align-items-center",
      key: index
      ...
      onClick: function onClick($event) {
        return _ctx.removeYear(index);
      }
    }, "x", 8 /* PROPS */, _hoisted_22)]);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_23, [_hoisted_24, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[3] || (_cache[3] = function ($event) {
      return _ctx.selectedTournamentType = $event;
    }),
    "class": "form-control rounded-0",
    onChange: _cache[4] || (_cache[4] = function () {
      return _ctx.addTournamentType && _ctx.addTournamentType.apply(_ctx, arguments);
    })
  }, [_hoisted_25, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.tournamentTypes, function (type, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: index
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(type), 1 /* TEXT */);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.selectedTournamentType]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_26, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.filters.tournamentType, function (type, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      "class": "badge bg-warning m-1 align-items-center",
      key: type
      ...
      "class": "ms-2 text-white cursor-pointer",
      onClick: function onClick($event) {
        return _ctx.removeTournamentType(index);
      }
    }, "x", 8 /* PROPS */, _hoisted_27)]);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_28, [_hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[5] || (_cache[5] = function ($event) {
      return _ctx.selectedCategory = $event;
    }),
    "class": "form-control rounded-0",
    onChange: _cache[6] || (_cache[6] = function () {
      return _ctx.handleCategoryChange && _ctx.handleCategoryChange.apply(_ctx, arguments);
    })
  }, [_hoisted_30, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.categories, function (category) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: category,
      value: category
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(category), 9 /* TEXT, PROPS */, _hoisted_31);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.selectedCategory]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_32, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.filters.category, function (category, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      "class": "badge bg-warning m-1 align-items-center",
      key: category
      ...
      "class": "ms-2 text-white cursor-pointer",
      onClick: function onClick($event) {
        return _ctx.removeCategory(index);
      }
    }, "x", 8 /* PROPS */, _hoisted_33)]);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_34, [_hoisted_35, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[7] || (_cache[7] = function ($event) {
      return _ctx.selectedWeight = $event;
    }),
    "class": "form-control rounded-0",
    onChange: _cache[8] || (_cache[8] = function () {
      return _ctx.addWeight && _ctx.addWeight.apply(_ctx, arguments);
    })
  }, [_hoisted_36, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.weights, function (weight) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: weight
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(weight), 1 /* TEXT */);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.selectedWeight]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_37, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.filters.weight, function (weight, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      "class": "badge bg-warning m-1 align-items-center",
      key: index
      ...
      "class": "ms-2 text-white cursor-pointer",
      onClick: function onClick($event) {
        return _ctx.removeWeight(index);
      }
    }, "x", 8 /* PROPS */, _hoisted_38)]);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_39, [_hoisted_40, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[9] || (_cache[9] = function ($event) {
      return _ctx.selectedWeightGroups = $event;
    }),
    "class": "form-control rounded-0",
    onChange: _cache[10] || (_cache[10] = function () {
      return _ctx.addWeightGroups && _ctx.addWeightGroups.apply(_ctx, arguments);
    })
  }, [_hoisted_41, ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.weightGroups, function (weightGroup) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: weightGroup
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(weightGroup), 1 /* TEXT */);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.selectedWeightGroups]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_42, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.filters.weightGroups, function (weight_group, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      "class": "badge bg-warning m-1 align-items-center",
      key: index
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(weight_group) + " ", 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "class": "ms-2 text-white cursor-pointer",
      onClick: function onClick($event) {
        return _ctx.removeWeightGroup(index);
      }
    }, "x", 8 /* PROPS */, _hoisted_43)]);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_44, [_hoisted_45, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[11] || (_cache[11] = function ($event) {
      return _ctx.selectedGender = $event;
    }),
    "class": "form-control rounded-0",
    onChange: _cache[12] || (_cache[12] = function () {
      return _ctx.addGender && _ctx.addGender.apply(_ctx, arguments);
    })
  }, _hoisted_49, 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.selectedGender]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_50, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.filters.gender, function (gender, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      "class": "badge bg-warning m-1 align-items-center",
      key: gender
      ...
      "class": "ms-2 text-white cursor-pointer",
      onClick: function onClick($event) {
        return _ctx.removeGender(index);
      }
    }, "x", 8 /* PROPS */, _hoisted_51)]);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_52, [_hoisted_53, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[13] || (_cache[13] = function ($event) {
      return _ctx.selectedCountry = $event;
    }),
    "class": "form-control rounded-0",
    onChange: _cache[14] || (_cache[14] = function () {
      return _ctx.addCountry && _ctx.addCountry.apply(_ctx, arguments);
    })
  }, [_hoisted_54, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <option value=\"ITA\">ITA</option> "), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.countries, function (country, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: index
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(country), 1 /* TEXT */);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.selectedCountry]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_55, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.filters.country, function (cnt, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      "class": "badge bg-warning m-1 align-items-center",
      key: index
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(cnt) + " ", 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      "class": "ms-2 text-white cursor-pointer",
      onClick: function onClick($event) {
        return _ctx.removeCountry(index);
      }
    }, "x", 8 /* PROPS */, _hoisted_56)]);
  }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_57, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    "class": "btn btn-warning w-100 rounded-0",
    style: {
      "margin-top": "22px"
    },
    onClick: _cache[15] || (_cache[15] = function () {
      return _ctx.applyFilters && _ctx.applyFilters.apply(_ctx, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.isLoading ? "Filtering..." : "Apply Filters"), 1 /* TEXT */)])])])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_58, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_59, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_60, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_61, [_hoisted_62, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_63, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_64, [_hoisted_65, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_VueMultiselect, {
    modelValue: _ctx.topOpentounaments,
    "onUpdate:modelValue": _cache[16] || (_cache[16] = function ($event) {
      return _ctx.topOpentounaments = $event;
    }),
    options: _ctx.maxOptions,
    multiple: false,
    placeholder: "Input Selection",
    label: "name",
    "track-by": "code",
    onSelect: _ctx.selected
  }, null, 8 /* PROPS */, ["modelValue", "options", "onSelect"])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_66, [_hoisted_67, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_VueMultiselect, {
    modelValue: _ctx.selectedSortings,
    "onUpdate:modelValue": _cache[17] || (_cache[17] = function ($event) {
      return _ctx.selectedSortings = $event;
    }),
    ...
    label: "name",
    "track-by": "code",
    onSelect: _ctx.sorted
  }, null, 8 /* PROPS */, ["modelValue", "options", "onSelect"])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_68, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_69, [_hoisted_70, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Display a message if there are no tournaments "), _ctx.tournaments && !_ctx.tournaments.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", _hoisted_71, _hoisted_73)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Iterate through tournaments and display data "), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.tournaments, function (tournament, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: tournament.id
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", _hoisted_74, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(index + 1), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", {
      title: tournament.club
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(tournament.name), 9 /* TEXT, PROPS */, _hoisted_75), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(tournament.official_ranking), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <td>\n                                                        {{\n                                                            tournament.ranking1\n                                                        }}\n                                                    </td>\n                                                    <td>\n                                                        {{\n                                                            tournament.ranking2\n                                                        }}\n                                                    </td> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)("".concat(tournament.win)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)("".concat(tournament.lose)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)("".concat(tournament.difference)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)("".concat(tournament.point_scored, " ")), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)("".concat(tournament.point_suffered, " ")), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(" ".concat(tournament.point_diff)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(tournament.total_matches), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(tournament.weight_group), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Button to view details "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
      "class": "btn btn-info btn-sm",
      onClick: function onClick($event) {
        return _ctx.openModal(index, $event);
      }
    }, " View ", 8 /* PROPS */, _hoisted_76)])]), _ctx.isModalOpen && _ctx.actionIndex === index ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", _hoisted_77, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_78, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_79, [_hoisted_80, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.tournamentData.athleteRankings, function (detail, detailIndex) {
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", {
        key: detailIndex
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.t_name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.official_ranking), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <td>\n                                                                        {{\n                                                                            detail.ranking1\n                                                                        }}\n                                                                    </td>\n                                                                    <td>\n                                                                        {{\n                                                                            detail.ranking2\n                                                                        }}\n                                                                    </td> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.win), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.lose), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.difference), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.point_scored), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.point_suffered), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(detail.point_diff), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [detail.matches && detail.matches.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_81, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(JSON.parse(detail.matches), function (match, matchIndex) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: matchIndex
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(match.opposition), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" (" + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(match.scores) + " - " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(match.opposition_scores) + ") ", 1 /* TEXT */)])]);
      }), 128 /* KEYED_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]);
    }), 128 /* KEYED_FRAGMENT */))])])])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */);
  }), 128 /* KEYED_FRAGMENT */))])])])])])])], 512 /* NEED_PATCH */)])])], 10 /* CLASS, PROPS */, _hoisted_1), _ctx.show ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_82, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_83, [_hoisted_84, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_85, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    "class": "subscribe-btn",
    id: "",
    onClick: _cache[18] || (_cache[18] = function ($event) {
      return _ctx.setPermission('one week');
    })
  }, " Try trial ")])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_86, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
    src: "".concat(_ctx.$images, "backgrounds/silver.png"),
    alt: "",
    "class": "card-brand"
  }, null, 8 /* PROPS */, _hoisted_87), _hoisted_88, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_89, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_90, null, 512 /* NEED_PATCH */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "subscribe-btn",
    onClick: _cache[19] || (_cache[19] = function ($event) {
      return _ctx.requestPay('oneMonth', 2, $event);
    })
  }, " $2 ")])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_91, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
    src: "".concat(_ctx.$images, "backgrounds/bronze.png"),
    alt: "",
    "class": "card-brand"
  }, null, 8 /* PROPS */, _hoisted_92), _hoisted_93, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_94, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_95, null, 512 /* NEED_PATCH */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "subscribe-btn",
    onClick: _cache[20] || (_cache[20] = function ($event) {
      return _ctx.requestPay('sixMonths', 10, $event);
    })
  }, " $10 ")])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_96, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
    src: "".concat(_ctx.$images, "backgrounds/gold.png"),
    alt: "",
    "class": "card-brand"
  }, null, 8 /* PROPS */, _hoisted_97), _hoisted_98, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_99, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_100, null, 512 /* NEED_PATCH */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "subscribe-btn",
    onClick: _cache[21] || (_cache[21] = function ($event) {
      return _ctx.requestPay('oneYear', 16, $event);
    })
  }, " $16 ")])])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 64 /* STABLE_FRAGMENT */);
}

/***/ }),

/***/ "./resources/js/initFirebase.js":
/*!**************************************!*\
  !*** ./resources/js/initFirebase.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.modal[data-v-999730d6] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 1000;\n  overflow: auto;\n  /* Enable modal content scrolling */\n}\n.modal-content[data-v-999730d6] {\n  background-color: #fff;\n  padding: 20px;\n  max-width: 80%;\n  max-height: 80%;\n  overflow: auto;\n  position: relative;\n}\n.close[data-v-999730d6] {\n  color: #aaa;\n  font-size: 28px;\n  font-weight: bold;\n  position: absolute;\n  /* Position it absolutely within the modal content */\n  top: 10px;\n  right: 10px;\n  cursor: pointer;\n  z-index: 1001;\n  /* Ensure it's above the modal content */\n}\n.right-sticky[data-v-999730d6] {\n  position: absolute;\n  /* Make it fixed when scrolling down */\n  top: 10px;\n  right: 10px;\n  cursor: pointer;\n}\n.fixed-close[data-v-999730d6] {\n  position: fixed;\n  top: 10px;\n  right: 10px;\n}\n.card[data-v-999730d6] {\n  border-radius: 1rem;\n}\n.card-body[data-v-999730d6] {\n  padding: 2rem;\n}\n.form-group[data-v-999730d6] {\n  margin-bottom: 1.5rem;\n}\nh5[data-v-999730d6] {\n  margin-bottom: 1.5rem;\n}\n.text-white[data-v-999730d6] {\n  color: #ffffff;\n}\n.cursor-pointer[data-v-999730d6] {\n  cursor: pointer;\n}\n.card-body h5[data-v-999730d6] {\n  font-weight: bold;\n}\n.btn-primary[data-v-999730d6] {\n  background-color: #0d6efd;\n  border-color: #0d6efd;\n}\n.table[data-v-999730d6] {\n  height: 50%;\n}\ntd[data-v-999730d6],\nth[data-v-999730d6] {\n  font-size: 10px;\n}\n.detail-section[data-v-999730d6] {\n  position: absolute;\n  background-color: white;\n  border: 1px solid black;\n  padding: 10px;\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./resources/css/app.css?vue&type=style&index=1&lang=css":
/*!*************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./resources/css/app.css?vue&type=style&index=1&lang=css ***!
  \*************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".wrapper.subscription {\r\n    width: calc(100vw - 270px);\r\n    background: linear-gradient(90deg, #ff9966, #ff5e62);\r\n    height: 100vh;\r\n    position: fixed;\r\n    top: 0;\r\n    right:0 ;\r\n    display: flex;\r\n    justify-content: center;\r\n    align-items: center;\r\n    flex-wrap: wrap;\n}\n.wrapper.subscription > div{\n}\n.fas.fa-envelope {\r\n    color: #fff;\r\n    font-size: 2rem;\r\n    background: #333;\r\n    padding: 1rem;\r\n    border-radius: 100%;\r\n    margin: 0 0 1rem 0;\n}\n.card-content {\r\n    width: 172px;\r\n    height: 240px;\r\n    background-color: #fff;\r\n    border-radius: 1rem;\r\n    padding: 10px 15px;\r\n    margin: 20px;\r\n    box-shadow: 1px 1px 2rem rgba(0, 0, 0, .3);\r\n    text-align: center;\r\n    position: relative;\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: space-between;\n}\n.card-content h1 {\r\n    text-transform: uppercase;\r\n    margin: 0 0 1rem 0;\n}\n.card-content p {\r\n    font-size: .8rem;\r\n    margin: 0 0 2rem 0;\n}\ninput {\r\n    padding: .8rem 1rem;\r\n    width: 40%;\r\n    border-radius: 5rem;\r\n    outline: none;\r\n    border: .1rem solid #d1d1d1;\r\n    font-size: .7rem;\n}\n::-moz-placeholder {\r\n    color: #d1d1d1;\n}\n::placeholder {\r\n    color: #d1d1d1;\n}\n.subscribe-btn {\r\n    padding: 10px 20px;\r\n    border-radius: 5rem;\r\n    background: linear-gradient(90deg, #ff9966, #ff5e62);\r\n    color: #fff;\r\n    font-size: .7rem;\r\n    border: none;\r\n    outline: none;\r\n    cursor: pointer;\n}\n.card-brand {\r\n    width: 80px;\r\n    height: auto;\r\n    position: absolute;\r\n    top: -25px;\r\n    right: -40px;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_AthleteRankings_vue_vue_type_style_index_2_id_999730d6_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_AthleteRankings_vue_vue_type_style_index_2_id_999730d6_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./resources/css/app.css?vue&type=style&index=1&lang=css":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./resources/css/app.css?vue&type=style&index=1&lang=css ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_app_css_vue_type_style_index_1_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../node_modules/vue-loader/dist/stylePostLoader.js!../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./app.css?vue&type=style&index=1&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./resources/css/app.css?vue&type=style&index=1&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_app_css_vue_type_style_index_1_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var C_Users_Administrator_Documents_mauro_milstone3_upworktask_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
const __exports__ = /*#__PURE__*/(0,C_Users_Administrator_Documents_mauro_milstone3_upworktask_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_Sidebar_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Sidebar_vue_vue_type_template_id_236a5a3e_lang_true__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/Components/Sidebar.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/Screens/Scraper/AthleteRankings.vue":
/*!**********************************************************!*\
  !*** ./resources/js/Screens/Scraper/AthleteRankings.vue ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _AthleteRankings_vue_vue_type_template_id_999730d6_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true */ "./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true");
/* harmony import */ var _AthleteRankings_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AthleteRankings.vue?vue&type=script&lang=js */ "./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=script&lang=js");
/* harmony import */ var _node_modules_vue_multiselect_dist_vue_multiselect_css_vue_type_style_index_0_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-multiselect/dist/vue-multiselect.css?vue&type=style&index=0&lang=css */ "./node_modules/vue-multiselect/dist/vue-multiselect.css?vue&type=style&index=0&lang=css");
/* harmony import */ var _css_app_css_vue_type_style_index_1_lang_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../css/app.css?vue&type=style&index=1&lang=css */ "./resources/css/app.css?vue&type=style&index=1&lang=css");
/* harmony import */ var _AthleteRankings_vue_vue_type_style_index_2_id_999730d6_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css */ "./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css");
/* harmony import */ var C_Users_Administrator_Documents_mauro_milstone3_upworktask_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
const __exports__ = /*#__PURE__*/(0,C_Users_Administrator_Documents_mauro_milstone3_upworktask_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_5__["default"])(_AthleteRankings_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_AthleteRankings_vue_vue_type_template_id_999730d6_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render],['__scopeId',"data-v-999730d6"],['__file',"resources/js/Screens/Scraper/AthleteRankings.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=script&lang=js":
/*!**********************************************************************************!*\
  !*** ./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=script&lang=js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_AthleteRankings_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_AthleteRankings_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./AthleteRankings.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=script&lang=js");
...
/***/ "./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true":
/*!****************************************************************************************************!*\
  !*** ./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_AthleteRankings_vue_vue_type_template_id_999730d6_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_AthleteRankings_vue_vue_type_template_id_999730d6_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=template&id=999730d6&scoped=true");
...
/***/ "./resources/css/app.css?vue&type=style&index=1&lang=css":
/*!***************************************************************!*\
  !*** ./resources/css/app.css?vue&type=style&index=1&lang=css ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_app_css_vue_type_style_index_1_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../node_modules/style-loader/dist/cjs.js!../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../node_modules/vue-loader/dist/stylePostLoader.js!../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./app.css?vue&type=style&index=1&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./resources/css/app.css?vue&type=style&index=1&lang=css");
...
/***/ "./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css":
/*!******************************************************************************************************************!*\
  !*** ./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css ***!
  \******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_AthleteRankings_vue_vue_type_style_index_2_id_999730d6_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Screens/Scraper/AthleteRankings.vue?vue&type=style&index=2&id=999730d6&scoped=true&lang=css");
